...
ARG NEXT_PUBLIC_PARTICIPANT_REGISTRATION_OPEN=true
ARG NEXT_PUBLIC_PAYMENT_PROOF_OPEN=false
...
ENV NEXT_PUBLIC_API_URL=$NEXT_PUBLIC_API_URL \
    ...
    NEXT_PUBLIC_PARTICIPANT_REGISTRATION_OPEN=$NEXT_PUBLIC_PARTICIPANT_REGISTRATION_OPEN \
    NEXT_PUBLIC_PAYMENT_PROOF_OPEN=$NEXT_PUBLIC_PAYMENT_PROOF_OPEN
